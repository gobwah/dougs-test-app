...
Once installed, open `documentation/analysis.md` and use Markdown preview (`Cmd+Shift+V` or `Ctrl+Shift+V`). Mermaid diagrams should display correctly.
...
mmdc -i documentation/analysis.md -o documentation/images/
```
